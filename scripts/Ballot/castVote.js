...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var contractAddress, index, wallet, provider, signer, balanceBN, balance, ballotContract, tx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    ballotContract = new ethers_1.Contract(contractAddress, ballotJson.abi, signer);
                    return [4 /*yield*/, ballotContract.vote(index)];
                case 2:
                    tx = _a.sent();
                ...
                case 3:
                    _a.sent();
                    console.log("Transaction completed. Hash: ".concat(tx.hash));
                    return [2 /*return*/];
            }
        });
    });
